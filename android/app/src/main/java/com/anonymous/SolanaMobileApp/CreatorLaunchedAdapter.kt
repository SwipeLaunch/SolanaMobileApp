...
class CreatorLaunchedAdapter(
    private val creators: List<CreatorMostLaunchedData>
) : RecyclerView.Adapter<CreatorLaunchedAdapter.CreatorViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CreatorViewHolder, position: Int) {
        ...
        holder.primaryMetric.text = "${creator.totalTokensLaunched} launched"
        holder.secondaryMetric.text = creator.getSuccessRateText()
        holder.mainStat.text = creator.totalTokensLaunched.toString()
        holder.subStat.text = creator.getFormattedTotalMarketCap()
